  ...
  return (
    <footer className="w-full py-6 md:py-8 bg-jobwise-dark/70 backdrop-blur-md border-t border-white/10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-white/80 hover:text-white transition-colors">Career Tips</a></li>
        ...
        <div className="mt-6 md:mt-8 pt-4 md:pt-6 border-t border-white/10 text-center text-white/80 text-sm">
